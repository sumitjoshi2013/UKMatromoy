...
export class EditprofileComponent implements OnInit {
  ...
  basicUserDetails :  object;

  constructor(private router: Router, private formBuilder: FormBuilder, private http: Http, 
    private dataservice: dataService,  private authService: AuthService, private route: ActivatedRoute
  ) {  }
  ...
  ngOnInit() {
    ...
    if(Id==null)
    {
      Id = this.authService.currentUser.name;
    }
    this.dataservice.getData(Url + "BasicProfileDetails?userid="+Id).subscribe((res: any) => { this.basicUserDetails = res });
